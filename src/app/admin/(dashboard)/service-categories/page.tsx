...
} from "@/server/actions/admin-service-categories";
...
export default async function AdminServiceCategoriesPage() {
  ...
  return (
    <div className="max-w-3xl space-y-8">
      <h1 className="text-xl font-bold text-zinc-900">Leistungs-Kategorien</h1>
      ...
      <ul className="space-y-3">
        {categories.map((c) => (
          ...
          >
            <form action={updateServiceCategoryAction} className="flex-1 space-y-2">
